...
import type { WidgetMessage, WidgetMode } from "@/features/widget/types";
...
export default function WidgetClient({ botId }: { botId: string }) {
  ...
  const [mode, setMode] = useState<WidgetMode>("gemini");
