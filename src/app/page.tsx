      ...
      <section className="relative isolate px-5 pb-20 pt-5 sm:px-8 lg:px-12 lg:pb-28">
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between rounded-2xl border border-[#e5e4de] bg-[#fbfaf7]/80 px-4 py-3 backdrop-blur-md sm:px-5">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <a className="inline-flex items-center gap-2 rounded-xl bg-[#1d2420] px-3.5 py-2.5 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#313b35] sm:px-4" href="#get-started">Build your bot <ArrowUpRight /></a>
          </div>
        </nav>
        ...
        <div className="mx-auto max-w-7xl pt-20 lg:pt-28" id="top">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#1d2420] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#1d2420]/10 transition hover:-translate-y-0.5" href="#get-started">Create your first bot <ArrowUpRight /></a>
