        ...
        <div className="mx-auto max-w-7xl pt-20 lg:pt-28" id="top">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#1d2420] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#1d2420]/10 transition hover:-translate-y-0.5" href="/dashboard">Create your first bot <ArrowUpRight /></a>
